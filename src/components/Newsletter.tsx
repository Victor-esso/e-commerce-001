...
const Newsletter = () => {
  return (
    <div className='w-full stack uni-pad mx-auto max-lg:!px-0'>
            ...
            <div className='w-full max-w-[488px] *:w-full vertical gap-8 px-8'>
                ...
                <div className='w-full horizontal  border-b border-natural-4/50 has-[input:focus]:border-natural-7'>
                    <label htmlFor="news" className='horizontal gap-2 h-[52px] w-full'>
                        ...
                        <input type="email" id='news' placeholder='Email Address' className='focus-within:outline-none w-full bg-transparent placeholder:text-natural-4 text-natural-7' />
                    </label>
